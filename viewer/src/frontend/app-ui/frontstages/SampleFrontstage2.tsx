...
export class SampleFrontstage2 extends FrontstageProvider {
          ...
          <StagePanel
            ...
            widgets={[
              <Widget control={TableWidget} fillZone={true}
                iconSpec="icon-table-2" labelKey="CivilViewerApp:components.table"
                applicationData={{
                  iModelConnection: UiFramework.getIModelConnection(),
  ...
  private get _switchLayout1(): CommandItemDef {
    return new CommandItemDef({
      ...
      labelKey: "CivilViewerApp:buttons.switchToLayout1",
      execute: async () => {
  ...
  private get _switchLayout2(): CommandItemDef {
    return new CommandItemDef({
      iconSpec: "icon-placeholder",
      labelKey: "CivilViewerApp:buttons.switchToLayout2",
      execute: async () => {
...
class SampleToolWidget extends React.Component<SampleToolWidgetProps> {
  ...
  public render(): React.ReactNode {
    ...
    const verticalItems = new ItemList([
      new GroupItemDef({
        labelKey: "CivilViewerApp:buttons.switchLayouts",
        iconSpec: "icon-placeholder",
        items: [
...
class SampleNavigationWidget extends React.Component {
  ...
  private get rotateSvgIcon(): React.ReactNode {
    return (
  ...
  public render() {
    ...
    rotateToolItemDef.iconSpec = this.rotateSvgIcon;
